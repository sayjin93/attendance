...
async function seedStudentsMSH1IE() {
  ...
  const studentsMSH1IE = [
    ...
    { firstName: "Ismail", lastName: "Bulluti", email: "ibulluti@uet.edu.al", classId: 11 },
    ...
    { firstName: "Mehmet", lastName: "Dova", email: "mdova@uet.edu.al", classId: 11 },
    ...
    { firstName: "Ertugël", lastName: "Mone", email: "emone@uet.edu.al", classId: 11 },
