...
async function seedStudentsMSH1INFA() {
  ...
  const studentsMSH1INFA = [
    ...
    { firstName: "Elvis", lastName: "Dylgjeri", email: "edylgjeri@uet.edu.al", classId: 12 },
    ...
    { firstName: "Daniel", lastName: "Hudhra", email: "dhidhra@uet.edu.al", classId: 12 },
    ...
    { firstName: "Frenki", lastName: "Meta", email: "fmeta@uet.edu.al", classId: 12 },
    { firstName: "Samir", lastName: "Meta", email: "smeta@uet.edu.al", classId: 12 },
    ...
    { firstName: "Jurgen", lastName: "Rade", email: "jrade@uet.edu.al", classId: 12 },
    { firstName: "Aurora", lastName: "Reci", email: "areci@uet.edu.al", classId: 12 },
    { firstName: "Kejsi", lastName: "Reçi", email: "kreçi@uet.edu.al", classId: 12 },
    ...
    { firstName: "Renato", lastName: "Vezi", email: "rvezi@uet.edu.al", classId: 12 },
